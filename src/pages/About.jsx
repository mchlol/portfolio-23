            ...
            <div className="about-section-content">
                ...
                <div className="about-section-text">
                    ...
                    <ul>
                        ...
                        <li className="gradient-border">Making this website was so much fun that I decided to learn to code for real this time, taking all sorts of online courses to develop foundational skills in HTML, CSS, and JavaScript. I got the bug!</li>
                        ...
                        <li className="gradient-border">I really enjoy front-end and I'm very interested to learn new frameworks, but I'm also learning Shopify, PHP and SQL among other things. I love to learn and love to build for the web.</li>
